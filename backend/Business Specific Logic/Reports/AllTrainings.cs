...
{
    public class AllTrainings : Report, IReport
    {
        public AllTrainings(string Owner) : base(Owner)
        {
        }

        public LoggedUser loggedUser { get; set; }

        public override string fileName => "All Trainings.xlsx";
        ...
        protected override void define()
        {
            using (var ctx = new TrainingContext())
            {
                ...
                #region DOCUMENT
                InitWorkBook("All Trainings");
                #endregion

                CreateWorkSheet("All Trainings");
                InsertHeader("All Trainings");

                #region Detail
                CurrentCell().LoadFromCollection(data);
                ws.Cells[3, 1, CurrentRow() - 1, 22].AutoFilter = true;
                #endregion
