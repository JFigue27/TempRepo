...
/**
 * @ngdoc service
 * @name Training.authService
 * @description
 * # authService
 * Factory in the Training.
 */
angular.module('Training').factory('authService', function($http, $q, localStorageService, appConfig, userService, $rootScope, $location) {
