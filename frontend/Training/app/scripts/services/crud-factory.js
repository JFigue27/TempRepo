...
angular.module('Training').service('validatorService', function() {
    var self = this;
    ...
    return function(oMainConfig) {
        ...
        var _createEntity = function(oEntityAux) {
            ...
            $http.post(appConfig.API_URL + mainEntity.entityName + '/Create', '=' + encodeURIComponent(JSON.stringify(oEntityAux)))
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        var backendResponse = response.data;
                        if (backendResponse.ErrorThrown) {
